...
export function AddStageDialog({ open, onOpenChange, onSuccess }: DialogModalProps<Stage>) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <Form {...form}>
        <form id="addStageForm" onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
